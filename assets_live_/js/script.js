$(window).on("load", function() {
    ...
    $('.settings-tab-feed ul li').on("click", function(){
        var tab_id = $(this).attr('data-tab');
        $('.settings-tab-feed ul li').removeClass('active');
        $('.product-feed-tab').removeClass('current');
        $(this).addClass('active animated fadeIn');
        $("#"+tab_id).addClass('current animated fadeIn');
        return false;
    ...
    //  ============= SOCIAL MEDIA HANDLES EDIT FUNCTION =========

    $(".media-open").on("click", function(){
        $("#media-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#media-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });


    //  ============= CONTACT INFORMATION EDIT FUNCTION =========

    $(".contact-open").on("click", function(){
        $("#contact-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
    ...
    $(".email-open").on("click", function(){
        $("#email-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#email-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
    ...
    $(".business-open").on("click", function(){
        $("#business-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#business-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
...
$(document).ready(function() {
    ...
    $(".explore-change-open").on("click", function(){
        $("#explore-change-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#explore-change-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
});
